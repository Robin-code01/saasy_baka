  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        {/* Navigation Links: Absolutely centered so it NEVER shifts */}
        <nav className="absolute left-1/2 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 items-center gap-6 text-sm font-medium text-foreground/75 md:flex">
